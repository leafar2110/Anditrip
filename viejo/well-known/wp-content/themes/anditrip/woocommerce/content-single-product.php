            ...
            <div>
              <div class="row">
               ...
               <div class="importante tab-pane  fade " id="tabBody2" role="tabpanel" aria-labelledby="tab2" aria-hidden="true" tabindex="0">
                ...
                <div class="precio tab-pane  fade " id="tabBody5" role="tabpanel" aria-labelledby="tab5" aria-hidden="true" tabindex="0">
                <div class="row">
                  <div class="col-md-12">
                    <h2 class="text-ceter"></h2>
                   <div class="border-include"></div>
                ...
                <div class="modal-dialog">
                  ...
                  <?php else: ?>
                   ...
                   <div class="texto-modal">
                       ...
                       <a href="<?php echo $url = 'https://' . $_SERVER['SERVER_NAME'].'/index.php/cart/'?>" class="btn btn-default btn-modal"><?php echo $see_cart;?></a></div>
                  <?php endif; ?>

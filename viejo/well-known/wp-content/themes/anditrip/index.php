              ...
              <a id="<?php echo $product_category->term_id; ?>" class="destiny" data-filter="<?php echo '.'.$product_category->term_id; ?>">
                <div class="grid">
                  <figure id="effect" class="effect">
                    ...
                    <img data-srcset="<?php echo $images[0]; ?>" alt="<?php echo $product_category->name;?>" class="lazy img-responsive"/>
        ...
        foreach ($terms  as $term  ) {
            ...
            ?>">
                ...
                <div class="card">
                  ...
                  ?>
                <img data-srcset="<?php echo $thumbnail[0]; ?>" alt="<?php echo $product_category->name;?>" class="lazy img-responsive"/>
                  </div>
                ...
                <div class="info-img">
                  <div class="grid">
                    <figure class="effect-colombia">
                      <?php $thumbnail_colombia = wp_get_attachment_image_src( get_post_thumbnail_id( $colombia->ID ), "medium" ); 
                  ?>
                <img data-srcset="<?php echo $thumbnail_colombia[0]; ?>" alt="<?php echo $product_category->name;?>" class="lazy img-responsive"/>
                      <figcaption class="figcaption-flexbox">
              ...
              <div class="col-sm-4 " >
                <div class="cards-blog">
                  <div class="card-thumb">
                    ...
                    <?php $thumbnail_post = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "medium" ); 
                      ?>
                    <img data-srcset="<?php echo $thumbnail_post[0]; ?>" alt="<?php echo $product_category->name;?>" class="lazy img-responsive"/></a>
                  </div>

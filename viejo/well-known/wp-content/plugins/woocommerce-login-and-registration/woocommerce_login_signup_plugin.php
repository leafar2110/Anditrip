...
?>        
			...
			<div class="col-set" id="customer_login">
				...
				<div class="col">
					...
					<div class="col-md-6">
						<div class="img-login">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_rojo_anditrip.svg" width="140px">	
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="col" >
							...
							<div class="col-md-6">
								...
								<?php $nonce_login_pop = wp_create_nonce( 'phoe_login_pop_form' ); ?>
									...
									<p class="form-row">
										<input type="hidden" id="_wpnonce" name="_wpnonce" value="fd684f83cf">
										<input type="hidden" id="wp_http_referer1" name="_wp_http_referer" value="<?php echo get_site_url(); ?>/index.php/my-account/"><div class="loader1" style="display:none;" ><img src="<?php echo plugins_url( '' , __FILE__ )."/assets/img/ajax-loader.gif" ?>"/></div>				
										<input type="submit" class="button js_login_log" name="login" value="Login" id="login1">
										<label for="rememberme" class="inline">
										<input name="rememberme" type="checkbox" id="rememberme" value="forever"> Remember me </label>
									</p>
						...
						<div class="col" >
							...
							<div class="col-md-6">
								<form method="post" class="register" id="js_signup" >			
									...
									<div style="left: -999em; position: absolute;"><label for="trap">Anti-spam</label><input type="text" name="email_2" id="trap" tabindex="-1"></div>						
									<p class="form-row">
										<input type="hidden" id="_wpnonce" name="_wpnonce" value="70c2c9e9dd"><input id="wp_http_referer" type="hidden" name="_wp_http_referer" value="<?php echo get_site_url(); ?>/index.php/my-account/">				
										<div class="loader_reg" style="display:none;" ><img src="<?php echo plugins_url( '' , __FILE__ )."/assets/img/ajax-loader.gif" ?>"/></div>				
										<input type="submit" class="button phoen_reg" name="register_header" value="Register">
									</p>

...
class WC_Admin_Taxonomies {
	...
	public function product_cat_description() {
		echo wpautop( __( 'Product destinations for your store can be managed here. To change the order of destinations on the front-end you can drag and drop to sort them. To see more destinations listed click the "screen options" link at the top-right of this page.', 'woocommerce' ) );
	}

	...
	public static function register_taxonomies() {
		...
		register_taxonomy( 'product_cat',
			...
			apply_filters( 'woocommerce_taxonomy_args_product_cat', array(
				...
				'labels' => array(
						'name'              => __( 'Product Destinations', 'woocommerce' ),
						'singular_name'     => __( 'Destination', 'woocommerce' ),
						'menu_name'         => _x( 'Destinations', 'Admin menu name', 'woocommerce' ),
						'search_items'      => __( 'Search Destinations', 'woocommerce' ),
						'all_items'         => __( 'All Destinations', 'woocommerce' ),
						'parent_item'       => __( 'Parent Destination', 'woocommerce' ),
						'parent_item_colon' => __( 'Parent Destination:', 'woocommerce' ),
						'edit_item'         => __( 'Edit Destination', 'woocommerce' ),
						'update_item'       => __( 'Update Destination', 'woocommerce' ),
						'add_new_item'      => __( 'Add new Destination', 'woocommerce' ),
						'new_item_name'     => __( 'New Destination name', 'woocommerce' ),
						'not_found'         => __( 'No Destinations found', 'woocommerce' ),
					),
				'show_ui'               => true,
				'query_var'             => true,
				'capabilities'          => array(
